<footer class="custom-footer-bg-gradient">
  ...
  <div class="container text-left">
    ...
    <script src="/assets/js/anime.min.js" crossorigin="anonymous"></script>  
    <script src="/assets/js/scrollreveal.min.js" crossorigin="anonymous"></script>  
