...
<div class=""
    ...
    <section class="container ">
        <div class="row mt-15">
            ...
            <div class=" col-sm-12 col-md-2 col-md-2 col-lg-2 col-xl-2 d-none d-sm-block d-sm-none d-md-block mt-n5" style="margin-right: -7rem;">
                <picture>
            ...
            <div class="col-sm-12 col-md-4 col-md-4 col-lg-4 col-xl-4 text-center">
                <img id="img-section-2-mens" width=150% style="margin-top:-100px" src="/assets/img/faq/Maskgroup@2x.png"
        ...
        <div>
            <hr>
            <button class="accordion">Apa keunggulan layanan Outsourcing IT dari Kazokku?</button>
            <div class="panel" style="margin-top:10px">
                <figure style="padding:20px" class="rounded-xl linear-gradient-blue border-blue-main">
                    <p style="margin-top:15px">
                        Kami dapat menyediakan kebutuhan tenaga IT profesional untuk penempatan di berbagai jenis proyek
                        digital sekaligus sesuai dengan kebutuhannya yang mendesak, kami juga mampu menyediakan tenaga
                        IT yang dibutuhkan dalam waktu singkat.
                    </p>
                </figure>
            </div>
            <hr>
            <button class="accordion">Apa saja spesialisasi tenaga IT yang dapat disediakan oleh Kazokku?</button>
            <div class="panel" style="margin-top:10px">
                <figure style="padding:20px" class="rounded-xl linear-gradient-blue border-blue-main">
                    <p style="margin-top:15px">
                        ...
                        Business Analyst, System Analyst, dan Digital Marketing. Adapun spesialisasi untuk developer
            ...
            <hr>
            <button class="accordion">Apa status karyawan yang disediakan oleh Kazokku untuk klien?</button>
            <div class="panel" style="margin-top:10px">
                <figure style="padding:20px" class="rounded-xl linear-gradient-blue border-blue-main">
                    <p style="margin-top:15px">
                        Statusnya adalah karyawan Kazokku sebagai karyawan outsource yang dipekerjakan untuk klien
                        selama kontrak berlangsung.
                    </p>
                </figure>
            </div>
            <hr>
            <button class="accordion">Berapa lama kontrak kerja yang dapat diterapkan?</button>
            <div class="panel" style="margin-top:10px">
                <figure style="padding:20px" class="rounded-xl linear-gradient-blue border-blue-main">
                    <p style="margin-top:15px">
            ...
            <hr>
            <button class="accordion">Bagaimana karyawan bekerja?</button>
            <div class="panel" style="margin-top:10px">
                <figure style="padding:20px" class="rounded-xl linear-gradient-blue border-blue-main">
                    <p style="margin-top:15px">
                        Karyawan bekerja mengikuti peraturan yang berlaku di kantor klien, termasuk jam kerja, cara
                        bekerja, perizinan, pengajuan cuti dan lain sebagainya.
                    </p>
                </figure>
            </div>
            <hr>
            <button class="accordion">Siapa yang akan mengelola tugas atau pekerjaan karyawan?</button>
            <div class="panel" style="margin-top:10px">
                <figure style="padding:20px" class="rounded-xl linear-gradient-blue border-blue-main">
                    <p style="margin-top:15px">
            ...
            <hr>
            <button class="accordion">Di mana karyawan bekerja?</button>
            <div class="panel" style="margin-top:10px">
                <figure style="padding:20px" class="rounded-xl linear-gradient-blue border-blue-main">
                    <p style="margin-top:15px">
                        Lokasi atau cara bekerja karyawan menyesuaikan dengan kebutuhan klien. Karyawan dapat bekerja di
                        kantor Kazokku, di kantor klien, atau secara remote.
                    </p>
                </figure>
            </div>
            <hr>
            <button class="accordion">Bagaimana jika klien ingin merekrut karyawan menjadi karyawan tetap
                klien?</button>
            <div class="panel" style="margin-top:10px">
                <figure style="padding:20px" class="rounded-xl linear-gradient-blue border-blue-main">
                    <p style="margin-top:15px">
                        Klien dapat merekrut karyawan Kazokku menjadi karyawan tetap setelah kontrak yang berlangsung
                        selama minimal 6 bulan selesai. Namun akan ada biaya rekrutmen yang perlu dibayarkan oleh klien.
                    </p>
                </figure>
            </div>
            <hr>
            <button class="accordion">Bagaimana jika karyawan yang diberikan memutuskan untuk mengundurkan
                diri?</button>
            <div class="panel" style="margin-top:10px">
                <figure style="padding:20px" class="rounded-xl linear-gradient-blue border-blue-main">
                    <p style="margin-top:15px">
                        Kami akan menyediakan karyawan pengganti sesuai dengan kualifikasi yang telah disepakati di awal
                        tanpa adanya biaya tambahan.
                    </p>
                </figure>
            </div>
            <hr>
            <button class="accordion">Bagaimana jika gaji karyawan pengganti lebih tinggi?</button>
            <div class="panel" style="margin-top:10px">
                <figure style="padding:20px" class="rounded-xl linear-gradient-blue border-blue-main">
                    <p style="margin-top:15px">
                        Apabila penggantian disepakati maka kami akan melakukan penyesuaian kontrak kerja dan nilai yang
                        ditagihkan kepada klien.
                    </p>
                </figure>
            </div>
            <hr>
            <button class="accordion">Bagaimana jika klien ingin menghentikan hubungan kerja dengan karyawan?</button>
            <div class="panel" style="margin-top:10px">
                <figure style="padding:20px" class="rounded-xl linear-gradient-blue border-blue-main">
                    <p style="margin-top:15px">
                        Penghentian hubungan kerja dapat dilakukan oleh klien sesuai dengan ketentuan yang diatur dalam
                        kontrak. Klien dapat berdiskusi dengan tim Kazokku dan menginfokan terlebih dahulu minimal dalam
                        waktu 30 hari terkait alasan penghentian hubungan kerja.
                    </p>
                </figure>
            </div>
            <hr>
            <button class="accordion">Berapa lama waktu yang dibutuhkan untuk mendapatkan karyawan pengganti?</button>
            <div class="panel" style="margin-top:10px">
                <figure style="padding:20px" class="rounded-xl linear-gradient-blue border-blue-main">
                    <p style="margin-top:15px">
                        Kami akan menyediakan karyawan pengganti secepat mungkin. Tidak ada biaya tambahan dalam proses
                        ini dan kami dapat menyediakan karyawan pengganti lebih dari 1 kali.
                    </p>
                </figure>
            </div>
            <hr>
            <button class="accordion">Bagaimana dengan penggajian dan benefit kepada karyawan?</button>
            <div class="panel" style="margin-top:10px">
                <figure style="padding:20px" class="rounded-xl linear-gradient-blue border-blue-main">
                    <p style="margin-top:15px">
                        Penggajian dan benefit akan dibayarkan oleh Kazokku kepada karyawan sesuai dengan ketentuan yang
                        diatur dalam kontrak.
                    </p>
                </figure>
            </div>
            <hr>
            <button class="accordion">Bagaimana jika karyawan lembur?</button>
            <div class="panel" style="margin-top:10px">
                <figure style="padding:20px" class="rounded-xl linear-gradient-blue border-blue-main">
                    <p style="margin-top:15px">
                        Jam lembur karyawan akan dibayar sesuai dengan aturan yang berlaku. Pihak Kazokku dan klien akan
                        melakukan konfirmasi terlebih dahulu, kemudian pihak Kazokku melakukan penagihan biaya lembur
                        yang disepakati kepada klien
                    </p>
                </figure>
            </div>
            <hr>
            <button class="accordion">Bagaimana jika karyawan bermasalah?</button>
            <div class="panel" style="margin-top:10px">
                <figure style="padding:20px" class="rounded-xl linear-gradient-blue border-blue-main">
                    <p style="margin-top:15px">
                        Tim Kazokku akan membantu menyelesaikan permasalahan melalui diskusi dengan karyawan dan klien.
                    </p>
                </figure>
            </div>
            <hr>
        ...
        <div class="col-12 col-sm-12 col-md-12 ol-lg-12 col-xl-12">
            <figure style="padding:30px" class="rounded-xl mt-3 mb-1 linear-gradient-blue border-blue-main">
                ...
                <p>
                    Jika anda ingin mendapatkan informasi lebih lanjut tentang layanan kami, seperti layanan Outsourcing
